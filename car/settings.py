...
SECRET_KEY = 'django-insecure-s%^a49$8q+g9^2=2#h(4a5jmphoim+*w5jrlgag4(i5ubo0iq6'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'car',       # Database name
        'USER': 'root',        # Username
        'PASSWORD': 'shayan',    # Password
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'myapp/static',  # Adjust the path to your app's static directory
]
